...
public class ResenhaEntity {
    ...
    public ResenhaEntity(long id, long usuarioId, long juegoId, boolean recomendado, String textoResena, double horasJugadas, LocalDateTime fechaPublicacion, LocalDateTime fechaUltimaEdicion, EstadoResenaEnum.Estado estado) {
        this.id = id;
    ...
    public EstadoResenaEnum.Estado getEstado() {
        return estado;
    }

    public void setEstado(EstadoResenaEnum.Estado estado) {
        this.estado = estado;
    }
}
